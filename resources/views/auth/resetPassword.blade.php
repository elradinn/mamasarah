    ...
    <main id="main">
        ...
        <section class="reset-password">
            <div class="container" data-aos="fade-up">
                ...
                <form action="/reset-password" method="post" role="form" class="p-3 p-md-4 php-email-form">
                    @csrf
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-md-6 text-center">
                                ...
                                @endif
                                <input id="user_account_email" name="email" class="form-control mb-4"
                                    value="{{ old('email') }}" required maxlength="50" placeholder="Enter email" />
                                <button class="w-100 mb-3 button">Reset Password</button>
                                <p class="text-center">
