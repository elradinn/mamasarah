                    ...
                    <div class="row justify-content-center">
                        <div class="card card-width">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="/change-password/{{ $token }}"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12">
                                            ...
                                            <input id="user_account_password" name="password"
                                                class="form-control form-control-sm" value="{{ old('password') }}"
                                                type="password" required maxlength="100" />
                                        </div>
                                        <div class="form-group col-12">
                                            <label for="user_account_password2">Confirm password</label>
                                            <input data-match="user_account_password" id="user_account_password2"
                                                name="password2" class="form-control form-control-sm"
                                ...
                                @if (isset($success))
                                    <span class="text-success">Change password done</span>
                                @endif
                                @if (isset($error))
                                    <span class="text-danger">Token not found!</span>
                                @endif
                            </div>
                        </div>
                    </div>
