        ...
        <div class="container">
            <div class="row justify-content-between gy-5">
                ...
                <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
                    <img src="{{ asset('img/logo.png') }}" class="img-fluid" alt="" data-aos="zoom-out"
                        data-aos-delay="300" />
                </div>
            </div>
        </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-4">
                    <div class="col-lg-7 position-relative about-img"
                        style="background-image: url('/img/about-us-image.jpg')" data-aos="fade-up"
                        data-aos-delay="150"></div>
                    <div class="col-lg-5 d-flex align-items-end" data-aos="fade-up" data-aos-delay="300">
                        <div class="content ps-0 ps-lg-5">
                            <p class="fst-italic">
                                Come savor the difference at Mama Sarah's Lettuce Garden, where every bite is a
                            ...
                            <p>
                                Our commitment to quality ensures that every dish is made with freshly picked lettuce,
                                offering you a
                                healthy and flavorful dining experience. At Mama Sarah's, we believe in the power of
                                fresh, wholesome
                                ingredients to nourish both body and soul. Join us and indulge in a menu that celebrates
                                the goodness of
                                nature's bounty, one leaf at a time.
                            </p>

                            <div class="position-relative mt-4">
                                <img src="{{ asset('/img/menus/honey-glazed-chicken-silog.jpg') }}" class="img-fluid"
                                    alt="" />
                            </div>
                        </div>
                    </div>
                                ...
                                @if ($browseDish->category_name == 'Silog')
                                    <div class="col-lg-4 menu-item">
                                        <a href="/storage/dishs/{{ $browseDish->image }}" class="glightbox"><img
                                                src="/storage/dishs/{{ $browseDish->image }}"
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-xl-4" data-aos="fade-up" data-aos-delay="300">
                            <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                                ...
                                <p>Depending on the food that you order, but usually it will take around 15-20 minutes
                                    to prepare the
                                    food </p>
                            </div>
                        </div>
            ...
            <div class="row gy-3">
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    ...
                    <div class="social-links d-flex">
                        ...
                        <a href="https://www.instagram.com/mamasarahslettucegarden/" target="_blank"
