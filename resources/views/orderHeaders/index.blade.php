                ...
                <div id="searchbar" class="form-row mb-4">
                    <div class="form-group col-lg-2">
                        <select id="search_col" onchange="searchChange()" class="form-control form-control-sm">
                            ...
                            <option value="UserAccount.address" {{request()->input('sc') == 'UserAccount.address' ? 'selected' : ''}}>User Account Address</option>
                            <option value="Status.name" {{request()->input('sc') == 'Status.name' ? 'selected' : ''}}>Status Name</option>
                        </select>
                    </div>
                    <div class="form-group col-lg-2">
                ...
                <table class="table table-sm table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="@getSortClass(UserAccount.name)"><a href="@getLink(sort,orderHeaders,UserAccount.name)">Name</a></th>
                            <th class="@getSortClass(UserAccount.address)"><a href="@getLink(sort,orderHeaders,UserAccount.address)">User Account Address</a></th>
                            <th class="@getSortClass(Status.name)"><a href="@getLink(sort,orderHeaders,Status.name)">Status Name</a></th>
                            <th>Actions</th>
                        </tr>
                    </thead>
                    <tbody>
