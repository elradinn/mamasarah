            ...
            <form method="post" action="/cartDetails?ref={{urlencode($ref)}}">
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-lg-4">
                        ...
                        <input id="cart_detail_cart_id" name="cart_id" class="form-control form-control-sm" value="{{old('cart_id')}}" type="number" />
                    ...
                    <div class="form-group col-md-6 col-lg-4">
                        ...
                        <input id="cart_detail_qty" name="qty" class="form-control form-control-sm" value="{{old('qty')}}" type="number" required />
