...
class CustomerOrderController extends Controller
{
    public function index()
    {
        ...
        $query = OrderHeader::query()
            ...
            ->select('OrderHeader.user_id','OrderHeader.id', 'OrderHeader.order_date', 'UserAccount.name as user_account_name', 'UserAccount.address as user_account_address', 'Status.name as status_name', 'OrderHeader.paymongo_id as order_paymongo_id')
